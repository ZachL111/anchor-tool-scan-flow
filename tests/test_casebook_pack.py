"""Regression checks for the anchor-tool-scan-flow casebook."""
...
from casebook.harness import assert_expected, anchor_tool_scan_flow_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(anchor_tool_scan_flow_summary(), assert_expected())
